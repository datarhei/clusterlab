...
local function cache_get(service)
...
local function records_comparator(a, b)
...
local function order_records_by_strategy(records, strategy)
  local ordered = {}
...
local function proxy_pass(records, strategy, proxy_timeout, http_timeout)
  local ok, err
...
_M.set("ttl", 1)                  -- srv records cache ttl in seconud
...
_M.set("proxy_timeout", 200)      -- in ms
